...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		// Check module loginfb installed
		$data['isset_loginfb'] = 0;
		$this->load->model('extension/extension');

		$extensions = $this->model_extension_extension->getExtensions('module');
		if(!empty($extensions))
			foreach ($extensions as $extension) {
				if($extension['code'] == 'loginfb') {
					$data['isset_loginfb'] = 1;
					$data['appid'] = $this->config->get('loginfb_appid');
					$data['appversion'] = $this->config->get('loginfb_appversion');
					break;
				}
			}
		...
		$data['entry_loginfb'] = $this->language->get('entry_loginfb');
	...
	public function loginfb() {
		...
		$isset = $this->model_account_customer->checkIssertCustomerEmail($this->request->post['email']);
		if($isset == true) {
