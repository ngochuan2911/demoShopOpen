...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_information_contact->addContact($this->request->post);
		...
		$data['store'] = $config_name[$config_language_id];

		$config_address = $this->config->get('config_address');
		$data['address'] = nl2br($config_address[$config_language_id]);
		...
		$data['googlemap'] = html_entity_decode($this->config->get('config_google_map'));
