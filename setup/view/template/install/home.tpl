            ...
            <tbody>
              <tr>
                ...
                <td class="text-center"><?php if ($php_version >= '5.3') { ?>
                  ...
                  <?php } else { ?>
                  <span class="text-danger"><i class="fa fa-minus-circle fa-2x"></i></span>
                  <?php } ?></td>
              </tr>
              <tr>
        ...
        <fieldset>
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $config_database; ?></td>
                <td><?php if (!file_exists($config_database)) { ?>
                  <span class="text-danger"><?php echo $text_missing; ?></span>
                  <?php } elseif (!is_writable($config_database)) { ?>
                  <span class="text-danger"><?php echo $text_unwritable; ?></span>
                  <?php } else { ?>
                  <span class="text-success"><?php echo $text_writable; ?></span>
                  <?php } ?></td>
              ...
              <tr>
                ...
                <td><?php if (!file_exists($license)) { ?>
                  <span class="text-danger"><?php echo $text_missing; ?></span>
                  <?php } elseif (!is_writable($license)) { ?>
                  <span class="text-danger"><?php echo $text_unwritable; ?></span>
                  <?php } else { ?>
                  <span class="text-success"><?php echo $text_writable; ?></span>
                  <?php } ?></td>
