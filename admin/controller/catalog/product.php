...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if($route == 'catalog/product/add') {
			$product_max = $this->model_catalog_product->getProductMax();
			$data['now'] = ($product_max ? ($product_max['product_id'] + 1) * ($product_max['product_id'] + 1) : '1');
		} else {
			$product_info = $this->model_catalog_product->getProduct($this->request->get['product_id']);
			$data['now'] = $product_info['product_id'] * $product_info['product_id'];
		}
		...
		if (isset($this->request->post['compare'])) {
			...
			$data['compare'] = $product_info['compare'];
		} else {
			$data['compare'] = 0;
		}
		...
		// Manufacturer
		$data['auto_manufacturers'] = $this->model_catalog_manufacturer->getManufacturers(array());
		...
		$data['auto_product_categories'] = $this->model_catalog_category->getCategories($filter_data_category);
		...
		$data['auto_product_filters'] = $this->model_catalog_filter->getFilters(array());
		...
		$data['auto_product_downloads'] = $this->model_tool_download->getDownloads(array());
