...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		if($route == 'catalog/manufacturer/add') {
			$manufacturer_max = $this->model_catalog_manufacturer->getManufacturerMax();
			$data['now'] = $manufacturer_max ? $manufacturer_max['manufacturer_id'] + 1 : '1';
		} else {
			$manufacturer_max = $this->model_catalog_manufacturer->getManufacturer($this->request->get['manufacturer_id']);
			$data['now'] = $manufacturer_max['manufacturer_id'];
		}
