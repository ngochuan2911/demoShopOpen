			...
			if (!$json) {
				...
				switch ($this->request->post['to']) {
					case 'newsletter':
						...
						$email_total = $this->model_customer_customer->getTotalCustomersReg($customer_data);

						$results = $this->model_customer_customer->getCustomersReg($customer_data);
				...
				if ($emails) {
					...
					$store_namez = $this->config->get('config_name');
					$store_name = $store_namez[$this->config->get('config_language_id')];
