...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_external'] = $this->language->get('text_external');
		$data['text_url_alias'] = $this->language->get('text_url_alias');
		$data['text_contact_form'] = $this->language->get('text_contact_form');
		...
		$data['cat_news'] = $this->url->link('news/category', 'token=' . $this->session->data['token'], true);
		...
		$data['download'] = $this->url->link('tool/download', 'token=' . $this->session->data['token'], true);
		...
		$data['information'] = $this->url->link('news/information', 'token=' . $this->session->data['token'], true);
		...
		$data['news'] = $this->url->link('news/news', 'token=' . $this->session->data['token'], true);
		...
		$data['comment'] = $this->url->link('news/comment', 'token=' . $this->session->data['token'], true);
		...
		$data['internal'] = $this->url->link('menu/link_internal', 'token=' . $this->session->data['token'], true);
		$data['external'] = $this->url->link('menu/link_external', 'token=' . $this->session->data['token'], true);
		$data['menu_group'] = $this->url->link('menu/menu_group', 'token=' . $this->session->data['token'], true);
		$data['url_alias'] = $this->url->link('design/url_alias', 'token=' . $this->session->data['token'], true);
		$data['lienhe'] = $this->url->link('marketing/lienhe', 'token=' . $this->session->data['token'], true);
		$data['newsletters'] = $this->url->link('marketing/newsletters', 'token=' . $this->session->data['token'], true);
