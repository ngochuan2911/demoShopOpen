...
class ControllerThemeThemeDefault extends Controller {
	...
	public function index() {
		...
		$data['entry_news_description_length'] = $this->language->get('entry_news_description_length');
		...
		$data['help_news_limit'] = $this->language->get('help_news_limit');
		$data['help_product_description_length'] = $this->language->get('help_product_description_length');
		$data['help_news_description_length'] = $this->language->get('help_news_description_length');
		...
		if (isset($this->error['news_description_length'])) {
			$data['error_news_description_length'] = $this->error['news_description_length'];
		} else {
			$data['error_news_description_length'] = '';
		}
		...
		if (isset($this->request->post['theme_default_news_limit'])) {
			$data['theme_default_news_limit'] = $this->request->post['theme_default_news_limit'];
		} elseif (isset($setting_info['theme_default_news_limit'])) {
			$data['theme_default_news_limit'] = $setting_info['theme_default_news_limit'];
		} else {
			$data['theme_default_news_limit'] = 15;
		}

		if (isset($this->request->post['theme_default_image_news_width'])) {
			$data['theme_default_image_news_width'] = $this->request->post['theme_default_image_news_width'];
		} elseif (isset($setting_info['theme_default_image_news_width'])) {
			$data['theme_default_image_news_width'] = $this->config->get('theme_default_image_news_width');
		} else {
			$data['theme_default_image_news_width'] = 228;
		}

		if (isset($this->request->post['theme_default_image_news_height'])) {
			$data['theme_default_image_news_height'] = $this->request->post['theme_default_image_news_height'];
		} elseif (isset($setting_info['theme_default_image_news_height'])) {
			$data['theme_default_image_news_height'] = $this->config->get('theme_default_image_news_height');
		} else {
			$data['theme_default_image_news_height'] = 228;
		}

		if (isset($this->request->post['theme_default_news_description_length'])) {
			$data['theme_default_news_description_length'] = $this->request->post['theme_default_news_description_length'];
		} elseif (isset($setting_info['theme_default_news_description_length'])) {
			$data['theme_default_news_description_length'] = $this->config->get('theme_default_news_description_length');
		} else {
			$data['theme_default_news_description_length'] = 300;
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_news_limit']) {
		...
		if (!$this->request->post['theme_default_news_description_length']) {
			$this->error['news_description_length'] = $this->language->get('error_limit');
		}
		...
		if (!$this->request->post['theme_default_image_news_width'] || !$this->request->post['theme_default_image_news_width']) {
			$this->error['image_news'] = $this->language->get('error_image_news');
		}

		if (!$this->request->post['theme_default_image_news_width'] || !$this->request->post['theme_default_image_news_height']) {
			$this->error['image_news'] = $this->language->get('error_image_news');
		}
