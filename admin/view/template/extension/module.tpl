							...
							<?php if($extensions) { ?><?php foreach ($extensions as $extension) { ?>
								<tr>
									...
									<td class="text-right"><?php if(!$extension['installed']) { ?>
										...
										<?php } ?>
										<?php if($extension['installed']) { ?><?php if($extension['module']) { ?>
								...
								<?php foreach ($extension['module'] as $module) { ?>
									<tr>
										...
										<td class="text-right"><a onclick="confirm('<?php echo $text_confirm; ?>') ? location.href='<?php echo $module['delete']; ?>' : false;" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
											<a href="<?php echo $module['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
									</tr>
								<?php } ?><?php } ?><?php } else { ?>
								<tr>
