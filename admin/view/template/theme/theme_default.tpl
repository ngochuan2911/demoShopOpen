					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-theme-default" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="theme_default_directory" id="input-directory" class="form-control">
										<?php foreach ($directories as $directory) { ?><?php if($directory == $theme_default_directory) { ?>
						...
						<fieldset>
							...
							<div class="form-group required">
								<label class="col-sm-2 control-label" for="input-image-news-width"><?php echo $entry_image_news; ?></label>
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-6">
											<input type="text" name="theme_default_image_news_width" value="<?php echo $theme_default_image_news_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-news-width" class="form-control" />
										</div>
										<div class="col-sm-6">
											<input type="text" name="theme_default_image_news_height" value="<?php echo $theme_default_image_news_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
										</div>
									</div>
									<?php if($error_image_news) { ?>
										<div class="text-danger"><?php echo $error_image_news; ?></div>
									<?php } ?>
								</div>
							</div>
							<div class="form-group required">
								<label class="col-sm-2 control-label" for="input-description-limit-news"><span data-toggle="tooltip" title="<?php echo $help_news_description_length; ?>"><?php echo $entry_news_description_length; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="theme_default_news_description_length" value="<?php echo $theme_default_news_description_length; ?>" placeholder="<?php echo $entry_news_description_length; ?>" id="input-description-limit-news" class="form-control" />
									<?php if($error_news_description_length) { ?>
										<div class="text-danger"><?php echo $error_news_description_length; ?></div>
									<?php } ?>
								</div>
							</div>
							<div class="form-group required">
								<label class="col-sm-2 control-label" for="input-catalog-limit"><span data-toggle="tooltip" title="<?php echo $help_news_limit; ?>"><?php echo $entry_news_limit; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="theme_default_news_limit" value="<?php echo $theme_default_news_limit; ?>" placeholder="<?php echo $entry_news_limit; ?>" id="input-catalog-limit" class="form-control" />
