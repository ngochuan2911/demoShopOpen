		...
		<div class="page-header">
			<div class="container-fluid">
				<div class="pull-right">
					...
					<a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a>
				</div>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tr>
									...
									<td class="text-left"><?php echo $column_menu_type; ?></a></td>
									<td class="text-right"><?php echo $column_column; ?></a></td>
								...
								<?php if($menus) { ?><?php foreach ($menus as $menu) { ?>
									<tr>
										<td class="text-center">
											<?php if(in_array($menu['menu_id'], $selected)) { ?>
											...
											<?php } ?></td>
										<td class="text-left"><?php echo $menu['name_id']; ?></td>
										<td class="text-left"><?php echo $menu['menu_type']; ?></td>
										<td class="text-right"><?php echo $menu['column']; ?></td>
										<td class="text-right">
