			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-comment" class="form-horizontal">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="news" value="<?php echo $news; ?>" placeholder="<?php echo $entry_news; ?>" id="input-news" class="form-control" /> <input type="hidden" name="news_id" value="<?php echo $news_id; ?>" />
							<?php if($error_news) { ?>
