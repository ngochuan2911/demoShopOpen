	...
	<div id="content">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label" for="input-news"><?php echo $entry_news; ?></label> <input type="text" name="filter_news" value="<?php echo $filter_news; ?>" placeholder="<?php echo $entry_news; ?>" id="input-news" class="form-control" />
								</div>
								<div class="form-group">
									<label class="control-label" for="input-author"><?php echo $entry_author; ?></label> <input type="text" name="filter_author" value="<?php echo $filter_author; ?>" placeholder="<?php echo $entry_author; ?>" id="input-author" class="form-control" />
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label" for="input-status"><?php echo $entry_status; ?></label> <select name="filter_status" id="input-status" class="form-control">
										<option value="*"></option>
							...
							<table class="table table-bordered table-hover">
								...
								<?php if($comments) { ?><?php foreach ($comments as $comment) { ?>
									<tr>
										...
										<td class="text-right"><?php echo $comment['rating']; ?></td>
		...
		<script type="text/javascript"><!--
			$('#button-filter').on('click', function (){
				...
				var filter_news = $('input[name=\'filter_news\']').val();
