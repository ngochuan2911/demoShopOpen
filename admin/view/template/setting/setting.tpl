					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<ul class="nav nav-tabs" id="language">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<li <?php if($nd == 1) echo 'class="active"'; ?>><a href="#config_meta_title-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
											<?php $nd++;} ?>
									</ul>
									<div class="tab-content">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<div class="tab-pane <?php if($nd == 1) echo 'active'; ?>" id="config_meta_title-language<?php echo $language['language_id']; ?>">
												<input type="text" name="config_meta_title[<?php echo $language['language_id']; ?>]" value="<?php echo $config_meta_title[$language['language_id']]; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title" class="form-control" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<ul class="nav nav-tabs" id="language">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<li <?php if($nd == 1) echo 'class="active"'; ?>><a href="#config_meta_description-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
											<?php $nd++;} ?>
									</ul>
									<div class="tab-content">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<div class="tab-pane <?php if($nd == 1) echo 'active'; ?>" id="config_meta_description-language<?php echo $language['language_id']; ?>">
												<textarea name="config_meta_description[<?php echo $language['language_id']; ?>]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description" class="form-control"><?php echo $config_meta_description[$language['language_id']]; ?></textarea>
											</div>
											<?php $nd++;} ?>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<ul class="nav nav-tabs" id="language">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<li <?php if($nd == 1) echo 'class="active"'; ?>><a href="#config_meta_keyword-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
											<?php $nd++;} ?>
									</ul>
									<div class="tab-content">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<div class="tab-pane <?php if($nd == 1) echo 'active'; ?>" id="config_meta_keyword-language<?php echo $language['language_id']; ?>">
												<textarea name="config_meta_keyword[<?php echo $language['language_id']; ?>]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword" class="form-control"><?php echo $config_meta_keyword[$language['language_id']]; ?></textarea>
											</div>
											<?php $nd++;} ?>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_theme" id="input-theme" class="form-control">
										<?php foreach ($themes as $theme) { ?><?php if($theme['value'] == $config_theme) { ?>
										...
										<?php } ?><?php } ?>
									</select> <br /> <img src="" alt="" id="theme" class="img-thumbnail" /></div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-layout"><?php echo $entry_layout; ?></label>
								<div class="col-sm-10">
									<select name="config_layout_id" id="input-layout" class="form-control">
										<?php foreach ($layouts as $layout) { ?><?php if($layout['layout_id'] == $config_layout_id) { ?>
						...
						<div class="tab-pane" id="tab-store">
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<ul class="nav nav-tabs" id="language">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<li <?php if($nd == 1) echo 'class="active"'; ?>><a href="#config_name-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
											<?php $nd++;} ?>
									</ul>
									<div class="tab-content">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<div class="tab-pane <?php if($nd == 1) echo 'active'; ?>" id="config_name-language<?php echo $language['language_id']; ?>">
												<input type="text" name="config_name[<?php echo $language['language_id']; ?>]" value="<?php echo $config_name[$language['language_id']]; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name" class="form-control" />
												<?php if($error_name) { ?>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<ul class="nav nav-tabs" id="language">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<li <?php if($nd == 1) echo 'class="active"'; ?>><a href="#config_owner-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
											<?php $nd++;} ?>
									</ul>
									<div class="tab-content">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<div class="tab-pane <?php if($nd == 1) echo 'active'; ?>" id="config_owner-language<?php echo $language['language_id']; ?>">
												<input type="text" name="config_owner[<?php echo $language['language_id']; ?>]" value="<?php echo $config_owner[$language['language_id']]; ?>" placeholder="<?php echo $entry_owner; ?>" id="input-name" class="form-control" />
												<?php if($error_owner) { ?>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<ul class="nav nav-tabs" id="language">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<li <?php if($nd == 1) echo 'class="active"'; ?>><a href="#config_address-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
											<?php $nd++;} ?>
									</ul>
									<div class="tab-content">
										<?php $nd = 1; foreach ($languages as $language) { ?>
											<div class="tab-pane <?php if($nd == 1) echo 'active'; ?>" id="config_address-language<?php echo $language['language_id']; ?>">
												<input type="text" name="config_address[<?php echo $language['language_id']; ?>]" value="<?php echo $config_address[$language['language_id']]; ?>" placeholder="<?php echo $entry_address; ?>" id="input-name" class="form-control" />
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-fax">Map:</label>
								<div class="col-sm-10">
									<input type="text" name="config_google_map" value="<?php echo $config_google_map; ?>" placeholder="Map" id="input-map" class="form-control" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_country_id" id="input-country" class="form-control">
										<?php foreach ($countries as $country) { ?><?php if($country['country_id'] == $config_country_id) { ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_language" id="input-language" class="form-control">
										<?php foreach ($languages as $language) { ?><?php if($language['code'] == $config_language) { ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_admin_language" id="input-admin-language" class="form-control">
										<?php foreach ($languages as $language) { ?><?php if($language['code'] == $config_admin_language) { ?>
											<option value="<?php echo $language['code']; ?>" selected="selected"><?php echo $language['name']; ?></option>
										<?php } else { ?>
											<option value="<?php echo $language['code']; ?>"><?php echo $language['name']; ?></option>
										<?php } ?><?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_currency" id="input-currency" class="form-control">
										<?php foreach ($currencies as $currency) { ?><?php if($currency['code'] == $config_currency) { ?>
								...
								<div class="col-sm-10">
									<label class="radio-inline">
										<?php if($config_currency_auto) { ?>
											...
											<?php echo $text_yes; ?><?php } else { ?>
											<input type="radio" name="config_currency_auto" value="1" />
											<?php echo $text_yes; ?><?php } ?>
									</label> <label class="radio-inline">
										<?php if(!$config_currency_auto) { ?>
											<input type="radio" name="config_currency_auto" value="0" checked="checked" />
											<?php echo $text_no; ?><?php } else { ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_length_class_id" id="input-length-class" class="form-control">
										<?php foreach ($length_classes as $length_class) { ?><?php if($length_class['length_class_id'] == $config_length_class_id) { ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="config_weight_class_id" id="input-weight-class" class="form-control">
										<?php foreach ($weight_classes as $weight_class) { ?><?php if($weight_class['weight_class_id'] == $config_weight_class_id) { ?>
						...
						<div class="tab-pane" id="tab-social">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="config_social_facebook" value="<?php echo $config_social_facebook; ?>" placeholder="<?php echo $entry_facebook; ?>" id="input-facebook" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-youtube"><?php echo $entry_youtube; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_social_youtube" value="<?php echo $config_social_youtube; ?>" placeholder="<?php echo $entry_youtube; ?>" id="input-facebook" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-youtube"><?php echo $entry_googleplus; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_social_googleplus" value="<?php echo $config_social_googleplus; ?>" placeholder="<?php echo $entry_googleplus; ?>" id="input-googleplus" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-youtube"><?php echo $entry_twitter; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_social_twitter" value="<?php echo $config_social_twitter; ?>" placeholder="<?php echo $entry_twitter; ?>" id="input-twitter" class="form-control" />
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_customer_group_id" id="input-customer-group" class="form-control">
											<?php foreach ($customer_groups as $customer_group) { ?><?php if($customer_group['customer_group_id'] == $config_customer_group_id) { ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_account_id" id="input-account" class="form-control">
											...
											<?php foreach ($informations as $information) { ?><?php if($information['information_id'] == $config_account_id) { ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_checkout_id" id="input-checkout" class="form-control">
											<option value="0"><?php echo $text_none; ?></option>
											<?php foreach ($informations as $information) { ?><?php if($information['information_id'] == $config_checkout_id) { ?>
												<option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
											<?php } else { ?>
												<option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
											<?php } ?><?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_order_status_id" id="input-order-status" class="form-control">
											<?php foreach ($order_statuses as $order_status) { ?><?php if($order_status['order_status_id'] == $config_order_status_id) { ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_fraud_status_id" id="input-fraud-status" class="form-control">
											<?php foreach ($order_statuses as $order_status) { ?><?php if($order_status['order_status_id'] == $config_fraud_status_id) { ?>
												<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
											<?php } else { ?>
												<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
											<?php } ?><?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_api_id" id="input-api" class="form-control">
											<option value="0"><?php echo $text_none; ?></option>
											<?php foreach ($apis as $api) { ?><?php if($api['api_id'] == $config_api_id) { ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_affiliate_id" id="input-affiliate" class="form-control">
											<option value="0"><?php echo $text_none; ?></option>
											<?php foreach ($informations as $information) { ?><?php if($information['information_id'] == $config_affiliate_id) { ?>
												<option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
											<?php } else { ?>
												<option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
											<?php } ?><?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_return_id" id="input-return" class="form-control">
											<option value="0"><?php echo $text_none; ?></option>
											<?php foreach ($informations as $information) { ?><?php if($information['information_id'] == $config_return_id) { ?>
												<option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
											<?php } else { ?>
												<option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
											<?php } ?><?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_return_status_id" id="input-return-status" class="form-control">
											<?php foreach ($return_statuses as $return_status) { ?><?php if($return_status['return_status_id'] == $config_return_status_id) { ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="config_captcha" id="input-return" class="form-control">
											<option value=""><?php echo $text_none; ?></option>
											<?php foreach ($captchas as $captcha) { ?><?php if($captcha['value'] == $config_captcha) { ?>
