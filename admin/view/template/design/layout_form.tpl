            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    <?php if ($layout_module['position'] == 'content_maintop') { ?>
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_mainbottom') { ?>
                    <option value="content_mainbottom" selected="selected"><?php echo $text_content_mainbottom; ?></option>
                    <?php } else { ?>
                    <option value="content_mainbottom"><?php echo $text_content_mainbottom; ?></option>
                    <?php } ?>
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="content_maintop"><?php echo $text_content_maintop; ?></option>';
    html += '    <option value="column_left"><?php echo $text_column_left; ?></option>';
    html += '    <option value="content_top"><?php echo $text_content_top; ?></option>';
    html += '    <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
    html += '    <option value="column_right"><?php echo $text_column_right; ?></option>';
    html += '    <option value="content_mainbottom"><?php echo $text_content_mainbottom; ?></option>';
    html += '  </select></td>';
