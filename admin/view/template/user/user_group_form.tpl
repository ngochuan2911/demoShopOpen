        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <a onclick="$(this).parent().find(':checkbox').prop('checked', true);" class="btn btn-primary"><?php echo $text_select_all; ?></a> <a onclick="$(this).parent().find(':checkbox').prop('checked', false);" class="btn btn-warning"><?php echo $text_unselect_all; ?></a></div>
          </div>
          <div class="form-group">
